...
./pi_pssh.sh $1 -t 10  "mount /dev/sda1 /mnt/"
echo `date` ":"  "Cleanin-up USB drive."
./pi_pssh.sh $1 -t 10  "rm -rf /mnt/*"
echo `date` ":"  "Copying usb image over..."
./pi_pscp.sh $1 -r -t 20 ../usb-rootfs-min/* /mnt/
echo `date` ":"  "Unmounting usb drive..."
./pi_pssh.sh $1 -t 10 "umount /dev/sda1"
echo `date` ":"  "Rebooting into usb mode."
./pi_pssh.sh $1 -t 10 "/sbin/pi_check_mount_usb"
