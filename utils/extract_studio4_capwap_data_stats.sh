...
rabins -r *${date_prefix}* -M 60m hard -m saddr daddr - tcp and src or dst net 10.30.0.0/16 -w - | rasort -r - -m saddr daddr -s saddr daddr dpkts spkts dbytes sbytes | tr -s ' ' > ${f_out}
